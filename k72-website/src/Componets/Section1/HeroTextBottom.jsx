  ...
  return (
    <div className=" flex flex-centre justify-center  ">
      ...
      <div className="font-[font2] text-white  mb-5 select-none">
        <Link
          className="text-[6.5vw] uppercase border-3 border-white rounded-full  px-8  justify-between leading-20 hover:text-[#D3FD50] hover:border-[#D3FD50]  mr-3 "
          to="/projects"
        >
          Projets
        </Link>
        <Link
          className="text-[6.5vw] uppercase border-3 border-white rounded-full px-8   justify-between leading-20 hover:text-[#D3FD50] hover:border-[#D3FD50] "
          to="/agence"
        >
          Agence
        </Link>
